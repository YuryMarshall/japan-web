...
const CompanyData: ICompanyData = {
  about:
    "Твой Japan — крупнейшая сеть турагенств в России и странах СНГ. Наша миссия — Ваш конфортный отдых в Японии, качественный сервис, незабываемые и приятные впечатления.",
  adress: {
    city: "Москва",
